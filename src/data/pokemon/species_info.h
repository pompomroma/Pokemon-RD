...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    // BBAKSAYON -- the reward for clearing the game and taking the hardest
    // mode. Deliberately above the Gen 3 legendary curve (680 BST, one point
    // over Mewtwo's 680-tier peers) without being unbeatable.
    [SPECIES_BBAKSAYON] =
    {
        .baseHP = 106,
        .baseAttack = 130,
